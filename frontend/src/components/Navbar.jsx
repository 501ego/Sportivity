                    ...
                    >
                      <div className='flex flex-row items-center p-2'>
                        <div className="flex flex-col items-start gap-2">
                          ...
                          >
                           <span className='text-xs font-light text-center'> ¡Aceptar!</span>
                          </button>
                          <button
                            className="bg-red-500 btn-xs rounded-md p-2 items-center flex text-slate-100 hover:bg-red-600 w-full justify-center"
                            
                          >
                            <span className='text-xs font-light text-center'>¡Rechazar!</span>
                          </button>
                        </div>
                        <div className='flex-col flex items-start w-full'>
                          <p className='ml-1 w-full flex'>
                            {request.name} desea unirse a tu comunidad {request.communityName}
                          </p>
                          </div>
                      </div>
                    </li>
